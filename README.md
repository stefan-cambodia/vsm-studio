...
temps réel (`audio/`, 835 tests, dont un test de concurrence réel vérifié
sous ThreadSanitizer) sont implémentés et **entièrement testés** — **1 254
tests moteur**, tous verts, zéro warning. Les 37 machines (Minimoog, TB-303, Juno-106,
