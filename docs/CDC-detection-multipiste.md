...
- **le vivier de machines** (mémoire permanente de l'utilisateur) : SIX
  ...
  (la réserve d'air, § 26), `vsm.carillon` (la cloche accordée, § 27) — et, sur la même branche, **la correction d'un
