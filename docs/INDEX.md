...
| A13 | **Trois boîtes sur dix coupent mal à 150 %** — « Aller à la mesure » et « Que faire de ce fichier ? » en français, le renommage en série dans les deux langues. Trois coupures sur quatre tombent dans l'espace d'un guillemet français. L'espace fine insécable (U+202F), hypothèse de D119, **réfutée par D120** : elle s'affiche juste mais JUCE coupe aussi à elle ; l'insécable U+00A0 empêche la coupure mais s'affiche deux fois plus large (D117). Reste une boîte qui fixe sa largeur — un chantier | `ROADMAP-daw.md` D117 → D120 | 4 photos sur 20 |
