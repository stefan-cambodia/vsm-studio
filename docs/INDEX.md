...
| A13 | **Trois boîtes sur dix coupent mal à 150 %** — « Aller à la mesure » et « Que faire de ce fichier ? » en français, le renommage en série dans les deux langues. Trois coupures sur quatre tombent dans l'espace d'un guillemet français. Hypothèse écrite : l'espace fine insécable (U+202F) | `ROADMAP-daw.md` D117 → D119 | 4 photos sur 20 |
