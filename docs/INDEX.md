...
| A16 | **L'afficheur de valeur des façades colle « : » en anglais** (« CUTOFF : 1.2 kHz ») — le reste de D131 : il n'apparaît qu'au mouvement d'un bouton, et aucun banc ne l'atteint ; il ne se corrige pas à l'aveugle. Il faut d'abord un geste de banc qui touche une commande de façade | `ROADMAP-daw.md` D131 | 1 site (`MachinePanelComponent.cpp:228`) |
