...
| A5 | **Quatre façades sur 63 gardent des boutons sous 18 px**, mesuré à l'écran sur les soixante-trois : `vsm.sampler`, `vsm.tr909`, `vsm.perc`, `vsm.fmdrums`. Ce sont des boîtes à rythmes, et leur **colonne par pièce est leur identité** — les empiler les rendrait méconnaissables pour gagner quatre pixels. Décision par machine, non faite | `ROADMAP-daw.md` D64 → D67 | 89 boutons sous 18 px → **37** ; 13 façades → **4** |
