...
| A20 | **Au dock par défaut, le nom de la sortie d'une ligne de piste ne se lit pas** (« -… ») — le reste de D136 : les six réglages ont leur place, l'instrument se lit, mais ~150 px utiles ne suffisent pas à trois boutons ET au nom d'un bus. Le nom entier revient dès la disposition large (436 px de ligne). Une question de largeur PAR DÉFAUT du dock des pistes, pas de mise en page | `ROADMAP-daw.md` D136 | sortie : « -… » au dock par défaut |
