...
| ~~A13~~ | ~~Trois boîtes sur dix coupent mal à 150 %~~ — **deux sur trois CLOSES par D121** : `BoiteLisible` met le texte d'une boîte que l'application construit dans un bloc que JUCE met en page APRÈS avoir fixé la largeur, et une cale impose la largeur de la ligne la plus longue. Reste « Que faire de ce fichier ? » (« minutes. » seul), une boîte STATIQUE de JUCE, et toutes celles de son espèce | `ROADMAP-daw.md` D117 → D121 | 4 photos sur 20 → **1** |
