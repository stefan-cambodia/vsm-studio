...
| A19 | **Au dock par défaut, six réglages de la ligne de piste ont une largeur nulle** — canal, muet, solo, armement, panoramique, sortie (D136 : chaque rangée pose ses éléments à largeur fixe, de gauche à droite, pour ~150 px utiles ; l'armement et la sortie ne sont pas dans le mixeur). Trouvé par le banc de D135 : la troisième rangée donne 170 px au volume, puis 90 au panoramique et 130 au sélecteur de sortie, et le dock des pistes en fait ~180 ; le panoramique reçoit une largeur NULLE (le geste de banc l'a trouvé « visible » et l'a mis à fond à gauche en l'appuyant). La famille de D123 (« + Ajouter une piste » écrasé) : une disposition qui suppose une largeur que le dock n'a pas | `ROADMAP-daw.md` D135 → D136 | 6 réglages à 0 px de large au dock par défaut |
