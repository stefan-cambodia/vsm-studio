...
| A19 | **Au dock par défaut, la ligne de piste n'a ni panoramique ni sortie utilisables** — trouvé par le banc de D135 : la troisième rangée donne 170 px au volume, puis 90 au panoramique et 130 au sélecteur de sortie, et le dock des pistes en fait ~180 ; le panoramique reçoit une largeur NULLE (le geste de banc l'a trouvé « visible » et l'a mis à fond à gauche en l'appuyant). La famille de D123 (« + Ajouter une piste » écrasé) : une disposition qui suppose une largeur que le dock n'a pas | `ROADMAP-daw.md` D135 | panoramique : 0 px de large au dock par défaut |
