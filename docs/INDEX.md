...
| A18 | **Quatre familles de commandes se règlent sans voir leur valeur** — le volume et le panoramique de chaque ligne de piste, le panoramique et les départs de chaque tranche du mixeur, les sept boutons MASTER (dont l'unité existe et n'est jamais montrée), tous les paramètres du panneau générique du rack. Aucune bulle de valeur dans l'application ; Cubase et Live en montrent une pendant le réglage | `ROADMAP-daw.md` D134 | 4 familles sans valeur ; 0 bulle de valeur |
