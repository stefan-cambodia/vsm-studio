...
| A17 | **L'afficheur de valeur d'une façade est hors de la vue quand on tourne un bouton** — vu sur la photo de D132 : il est posé au bas de la façade, sous le séquenceur, et dans la disposition par défaut le rack coupe la façade du TB-303 à l'en-tête « PATTERN ». Le relevé des textes le lit (`isVisible()`), l'écran ne le montre pas. Le musicien règle sans voir la valeur, sauf à faire défiler | `ROADMAP-daw.md` D132 | l'afficheur sous le bord visible du rack, fenêtre 1 264 × 742 |
