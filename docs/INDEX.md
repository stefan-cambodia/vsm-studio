...
| A15 | **Les boîtes statiques de JUCE — 113 sites — coupent rarement mal, et dessinent leur texte par-dessus l'icône** — D125 : douze boîtes de la famille photographiées en français et en anglais, une seule mauvaise coupure (« it. » seul dans « The disk did not keep up ») ; JUCE garde, faute d'équilibre à 10 % près, la largeur où les deux dernières lignes sont les PLUS déséquilibrées. Hors définition : le texte chevauche l'icône dans les douze boîtes à icône | `ROADMAP-daw.md` D125 | français **0 / 12**, anglais **1 / 12** |
